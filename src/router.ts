...
/*   EVENTS   */
appRouter.post('/events', [authMiddlewares.isAuthenticated, authMiddlewares.isAdmin], createNewEvent); // Create new event
...
appRouter.post('/stripe/webhook/invoice', [], webhookInvoice); // handle payment events
